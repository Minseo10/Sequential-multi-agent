...
class AdvancedSelfConsistency:
    def __init__(self, client, model: str, num_samples: int = 6, similarity_threshold: float = 0.8):
        self.client = client
    ...
    def generate_responses(self, system_prompt: str, user_prompt: str, image) -> List[str]:
        responses = []
    ...
    def evaluate(self, system_prompt: str, user_prompt: str, image) -> Dict[str, any]:
        responses = self.generate_responses(system_prompt, user_prompt, image)
...
def advanced_self_consistency_approach(system_prompt: str, initial_query: str, client, model: str, num_samples, similarity_threshold, image) -> str:
    self_consistency = AdvancedSelfConsistency(client, model, num_samples, similarity_threshold)
    result = self_consistency.evaluate(system_prompt, initial_query, image)
