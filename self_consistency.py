...
def advanced_self_consistency_approach(system_prompt: str, initial_query: str, client, model: str, num_samples, image) -> str:
    self_consistency = AdvancedSelfConsistency(client, model, num_samples)
